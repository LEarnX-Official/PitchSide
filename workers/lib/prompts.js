...
const PERSONAS = {
  hype:
    'You are an ecstatic, high-energy football commentator. React to match ' +
    'events with vivid, punchy, crowd-thrilling one-liners. Max 2 sentences.',
  analyst:
    'You are a calm tactical football analyst. Explain the significance ' +
    'of match events in clear, insightful terms. Max 2 sentences.',
  banter:
    'You are a witty football pundit with dry humor. Add playful banter to ' +
  ...
  return [
    {
      role: 'system',
      content:
        'You are a knowledgeable, concise football expert answering a fan during a live watch-party. Answer in 1-3 sentences.'
    },
    {
      role: 'user',
      content:
