...
// Return the machine's first non-internal IPv4 (its LAN address), so a local-mode
// host can build a join code that guests on the same network can connect to.
ipcMain.on('lan-ip', (evt) => {
  let ip = null
